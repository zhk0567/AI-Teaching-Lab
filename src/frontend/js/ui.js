...
const UI = {
        ...
        container.innerHTML = `
            <button onclick="fillPrompt('${PROMPTS.start.text}')" 
                ...
                <div class="flex justify-between items-center mb-1">
                    <span class="font-bold text-blue-700">${PROMPTS.start.label}</span>
        ...
        container.innerHTML = `
            <div class="p-4 bg-green-50 rounded-lg text-center border-2 border-green-200 mt-10">
                ...
                <p class="text-xs text-green-600 mt-2">
                    恭喜！你已完成 ${GROUP_CONFIG.GROUP2.TARGET_TURNS} 轮深度探索，已掌握 C++ 指针概念！
                </p>
    ...
    updateInputState() {
        ...
        const locked = AppState.isAiTyping || AppState.showHighlightTask || AppState.waitingForView || doneG1 || doneG2;
        ...
        if (dot) {
            dot.className = AppState.isAiTyping
